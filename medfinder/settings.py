...
STATICFILES_DIRS = [
    BASE_DIR / "static",  # aponta pra pasta 'static' que está fora da pasta medfinder
]
...
SECRET_KEY = 'django-insecure-^%r4wlor@e83zh@mowch(1ewmg16lgn*rr%tw@*gq0a$t9eji5'
